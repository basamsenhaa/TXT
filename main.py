# Don't Remove Credit Tg - @𝐒ᎥηᎥɑ
# Ask Doubt on telegram @𝐒ᎥηᎥɑ
...
OWNER_ID = 6749667797 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [6749667797,3303334633]
